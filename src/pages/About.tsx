      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6 pr-[1in] pl-4 md:pl-6">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            description="<em>render</em>, created by Writing and Rhetoric graduate Katherine Nikolau, celebrates the creative work and activism of nine justice-impacted artists."
